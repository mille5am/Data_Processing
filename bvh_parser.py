...
#if (len(sys.argv)!=2):
#    print( 'Usage: python bvhparser.py /Users/Amanda/Documents/Noitom/untitled folder/Data_Processing/Matt_lift_1_Char00.bvh')
#    sys.exit()

#filename = sys.argv[1]
filename = 'Matt_STS_6_Char00.bvh'

#f = file().read()
f = open('Matt_STS_6_Char00.bvh','r')
f = f.read()
